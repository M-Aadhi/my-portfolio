...
function processCommand(command) {
  ...
  switch (args[0]) {
    ...
    case "banner": 
      ...
      case "gui":
        commandIndex = addCommandToHistory(args, comandHistory, commandIndex);
        window.location.href = "index.html"; // Change the window location to index.html
        break;      
    case "clear":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
      setTimeout( () =>
    ...
    case "pwd":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
      renderLine("<br>/home/vimal/projects/cliPortafolio<br><br>");
      break
    case "echo":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
    ...
    case "cd":
      ...
      if (args[1] === "music") {
        ...
        newTab("https://open.spotify.com/artist/29aw5YCdIw2FEXYyAJZI8l");
      } else if (args[1] === "blog") {
        renderLine("Opennig blog...", 80);
        newTab("https://medium.com/@2004.vimald");
